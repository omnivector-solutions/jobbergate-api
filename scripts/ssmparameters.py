...
PARAM_KEYS = (
    ...
    "JOBBERGATE_VALID_EMAIL_DOMAINS",
...
PARAM_TEMPLATE = inspect.cleandoc(
    ...
    JOBBERGATE_VALID_EMAIL_DOMAINS = {JOBBERGATE_VALID_EMAIL_DOMAINS!a}
    RESET_PASSWORD_VERIFICATION_URL = {RESET_PASSWORD_VERIFICATION_URL!a}
